...
class _DetailScreenState extends ConsumerState<DetailScreen> {
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const Padding(
                              ...
                              child: Text(
                                'Attribution: https://unsplash.com/?utm_source=dark_walls&utm_medium=referral',
                                maxLines: 1,
                                overflow: TextOverflow.ellipsis,
                                style: TextStyle(
  ...
  Future<void> _download() async {
    ...
    try {
      final filePath = await _ensureLocalFile();
      await Gal.putImage(filePath, album: 'DarkWalls');
      if (mounted) {
        setState(() => _isBusy = false);
  ...
  Future<String> _ensureLocalFile() async {
    ...
    final filePath = '${dir.path}/darkwalls_${widget.wallpaper.id}.jpg';
